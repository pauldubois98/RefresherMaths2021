...
\begin{definition}[$(x_n) \subseteq X$ converges to $x \in X$]
...
\begin{proof}
	from def
\end{proof}
\begin{theorem}[Sand-wish Theorem / Two Policemen Theorem]
...
\begin{definition}[Compactness (over $\R^n$)]
